...
def testSexNationalBaseTable(mock_acs: mock.MagicMock):
    ...
    #         [
    #             "sex",
    #             "high_school_or_higher_pct_rate",
    #             "high_school_or_higher_pct_share",
    #             "high_school_or_higher_population_pct",
    #             "high_school_or_higher_pct_relative_inequity",
    #             "high_school_or_higher_estimated_total",
    #             "high_school_or_higher_pop_estimated_total",
    #         ]
    #     ].to_string()
    # )
...
#     assert mock_acs.call_count == ((RACES * GEOS) + GEOS + GEOS) * CONDITIONS
