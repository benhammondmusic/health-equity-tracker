...
def get_ahr_standard_age_bucket(age_range):
    ...
    elif age_range in {'18-19', '20-24', '20-20', '21-21', '22-24', '25-29', '30-34', '35-44', '35-39', '40-44'}:
        return '18-44'
...
class ACSPopulationIngester:
    ...
    def write_to_bq(self, dataset, gcs_bucket):
        ...
        for table_name, df in frames.items():
            ...
            gcs_to_bq_util.add_df_to_bq(
                df_for_time_series, dataset, f'{table_name}_time_series', column_types=column_types, overwrite=overwrite
            )
    ...
    def standardize_race_include_hispanic(self, df):
        ...
        by_hispanic[std_col.RACE_CATEGORY_ID_COL] = by_hispanic.apply(
            lambda r: (Race.HISP.value if r[std_col.HISPANIC_COL] == 'Hispanic or Latino' else Race.NH.value), axis=1
        )
        ...
        by_race[std_col.RACE_CATEGORY_ID_COL] = by_race.apply(
            lambda r: RACE_STRING_TO_CATEGORY_ID_INCLUDE_HISP[r[std_col.RACE_COL]], axis=1
        )
    ...
    def get_sex_by_age_and_race(self, var_map, sex_by_age_frames):
        ...
        for concept, race in SEX_BY_AGE_CONCEPTS_TO_RACE.items():
            ...
            sex_by_age = standardize_frame(
                frame, group_vars, [std_col.SEX_COL, std_col.AGE_COL], self.county_level, std_col.POPULATION_COL
            )
