...
acs_condition_exporter_payload_race = {'dataset_name': _ACS_DATASET_NAME, 'demographic': "by_race"}
acs_condition_exporter_operator_race = util.create_exporter_operator(
    "acs_condition_exporter_race", acs_condition_exporter_payload_race, data_ingestion_dag
)

acs_condition_exporter_payload_age = {'dataset_name': _ACS_DATASET_NAME, 'demographic': "by_age"}
...
acs_condition_exporter_payload_sex = {'dataset_name': _ACS_DATASET_NAME, 'demographic': "by_sex"}
...
(
    ...
    >> [acs_condition_exporter_operator_race, acs_condition_exporter_operator_age, acs_condition_exporter_operator_sex]
)
