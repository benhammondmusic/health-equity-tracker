...
ahr_bq_payload = util.generate_bq_payload(_AHR_WORKFLOW_ID, _AHR_DATASET_NAME)
ahr_pop_bq_operator = util.create_bq_ingest_operator('ahr_to_bq', ahr_bq_payload, data_ingestion_dag)

ahr_exporter_payload_race = {'dataset_name': _AHR_DATASET_NAME, 'demographic': "race_and_ethnicity"}
ahr_exporter_operator_race = util.create_exporter_operator(
    'ahr_exporter_race', ahr_exporter_payload_race, data_ingestion_dag
)

ahr_exporter_payload_age = {'dataset_name': _AHR_DATASET_NAME, 'demographic': "age"}
ahr_exporter_operator_age = util.create_exporter_operator(
    'ahr_exporter_age', ahr_exporter_payload_age, data_ingestion_dag
)

ahr_exporter_payload_sex = {'dataset_name': _AHR_DATASET_NAME, 'demographic': "sex"}
