...
acs_pop_exporter_payload_race = {'dataset_name': _ACS_DATASET_NAME, 'demographic': "by_race"}
...
acs_pop_exporter_payload_age = {'dataset_name': _ACS_DATASET_NAME, 'demographic': "by_age"}
...
acs_pop_exporter_payload_sex = {'dataset_name': _ACS_DATASET_NAME, 'demographic': "by_sex"}
...
(
    ...
    >> [acs_pop_exporter_operator_race, acs_pop_exporter_operator_age, acs_pop_exporter_operator_sex]
)
